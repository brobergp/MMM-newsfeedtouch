...
| `readInterval`  | HFor how long should the description be shown before it closes and loads next headline? (Milliseconds). <br><br> **Possible values:**`1000` - `60000` <br> **Default value:** `15000` (15 seconds)
